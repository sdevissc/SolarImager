/****************************************************************************
** Meta object code from reading C++ file 'CameraInterface.h'
**
...
#error "The header file 'CameraInterface.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 31, 3) // "msg"
    ...
    "CameraInterface\0errorOccurred\0\0msg"
};
...
void CameraInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CameraInterface::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraInterface::errorOccurred)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraInterface::errorOccurred(const QString & _t1)
{
