...
QT_MOC_LITERAL(6, 33, 1) // "h"

    },
    "PreviewWidget\0roiSelected\0\0x\0y\0w\0h"
};
...
void PreviewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->roiSelected((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PreviewWidget::*)(int , int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PreviewWidget::roiSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PreviewWidget::roiSelected(int _t1, int _t2, int _t3, int _t4)
{
