...
QT_MOC_LITERAL(4, 29, 14), // "recordingStats"
QT_MOC_LITERAL(5, 44, 3), // "fps"
QT_MOC_LITERAL(6, 48, 4), // "mbps"
QT_MOC_LITERAL(7, 53, 10), // "framesDone"
QT_MOC_LITERAL(8, 64, 17) // "recordingFinished"

    },
    "FrameGrabber\0frameReady\0\0img\0"
    "recordingStats\0fps\0mbps\0framesDone\0"
    "recordingFinished"
};
...
void FrameGrabber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->recordingStats((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            using _t = void (FrameGrabber::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrameGrabber::frameReady)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FrameGrabber::*)(double , double , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrameGrabber::recordingStats)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (FrameGrabber::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FrameGrabber::recordingFinished)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FrameGrabber::staticMetaObject = { {
    ...
    qt_meta_stringdata_FrameGrabber.data,
    qt_meta_data_FrameGrabber,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void FrameGrabber::frameReady(QImage _t1)
{
...
// SIGNAL 1
void FrameGrabber::recordingStats(double _t1, double _t2, int _t3)
{
...
// SIGNAL 2
void FrameGrabber::recordingFinished()
{
